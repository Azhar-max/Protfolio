...
// For Railway, we use HTTP instead of HTTPS
if (isRailway) {
  // Start server on HTTP for Railway
  ...
  // Check if certificates exist for local development
  ...
  server.listen(PORT, () => {
    console.log(`HTTPS/HTTP/2 Server running on port ${PORT}`);
    console.log('Press Ctrl+C to stop the server');
